...
test("@TES13 @p1 @settings-center @tools 工具页展示快捷键和资源", async ({ authedPage }) => {
  ...
  await expect(content.locator('a[href="https://chromewebstore.google.com/detail/octo-%E6%8F%92%E4%BB%B6%E7%89%88/nemameogpfkponoomeblkjcnbidgmndk"]')).toBeVisible();
  await expect(content.locator('a[href="https://github.com/Mininglamp-OSS/openclaw-channel-octo"]')).toBeVisible();
});
