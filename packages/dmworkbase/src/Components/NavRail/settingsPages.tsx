...
export const settingsResourceGroups: ResourceGroup[] = [
  {
    ...
    category: "clients",
    resources: [
      { id: "android", titleKey: "base.navRail.settingsCenter.resource.android", descriptionKey: "base.navRail.settingsCenter.resource.androidDescription", status: "available", statusKey: "base.navRail.settingsCenter.resource.available", url: "https://github.com/Mininglamp-OSS/octo-android/releases/latest", actionKey: "base.navRail.settingsCenter.action.download" },
      { id: "iphone", titleKey: "base.navRail.settingsCenter.resource.iphone", descriptionKey: "base.navRail.settingsCenter.resource.iosDescription", status: "coming-soon", statusKey: "base.navRail.settingsCenter.resource.appStorePending", actionKey: "base.navRail.settingsCenter.action.download" },
    ],
  },
  {
    ...
    category: "clients",
    resources: [
      { id: "windows", titleKey: "base.navRail.settingsCenter.resource.windows", descriptionKey: "base.navRail.settingsCenter.resource.windowsDescription", status: "coming-soon", statusKey: "base.navRail.settingsCenter.resource.comingSoon" },
      { id: "macos", titleKey: "base.navRail.settingsCenter.resource.macos", descriptionKey: "base.navRail.settingsCenter.resource.macosDescription", status: "coming-soon", statusKey: "base.navRail.settingsCenter.resource.comingSoon" },
    ],
  },
  {
    ...
    category: "resources",
    resources: [
      { id: "chrome", titleKey: "base.navRail.settingsCenter.resource.chrome", descriptionKey: "base.navRail.settingsCenter.resource.chromeDescription", status: "available", statusKey: "base.navRail.settingsCenter.resource.projectConfirmed", url: "https://chromewebstore.google.com/detail/octo-%E6%8F%92%E4%BB%B6%E7%89%88/nemameogpfkponoomeblkjcnbidgmndk", actionKey: "base.navRail.settingsCenter.action.viewProject" },
      { id: "openclaw", titleKey: "base.navRail.settingsCenter.resource.openclaw", descriptionKey: "base.navRail.settingsCenter.resource.openclawDescription", status: "available", statusKey: "base.navRail.settingsCenter.resource.projectConfirmed", url: "https://github.com/Mininglamp-OSS/openclaw-channel-octo", actionKey: "base.navRail.settingsCenter.action.viewProject" },
    ],
  },
];
...
export function SettingsPage({ item, environment, accountCenterUrl, onSecrets, onAbout, onChangelog, onOpenOnboarding }: { item?: SettingsItem; environment: import("../../Runtime").RuntimeEnvironment; accountCenterUrl?: string; onSecrets?: () => void; onAbout?: () => void; onChangelog?: () => void; onOpenOnboarding?: () => void }) {
  ...
  if (item?.id === "devices") return <SettingsPageFrame title={t("base.navRail.settingsCenter.page.devices.title")}><div className="wk-settings-center__resource-sections">{settingsResourceGroups.map((group) => <ResourceSection key={group.titleKey} title={t(group.titleKey)} category={group.category}>{group.resources.map((resource) => <ResourceCard key={resource.id} {...resource} title={t(resource.titleKey)} description={t(resource.descriptionKey)} statusLabel={t(resource.statusKey)} category={group.category} action={resource.url && resource.actionKey ? <a className={`wk-settings-center__resource-action${group.category === "clients" ? " wk-settings-center__resource-action--client" : ""}`} href={resource.url} target="_blank" rel="noreferrer"><ExternalLink aria-hidden="true" />{t(resource.actionKey)}</a> : undefined} />)}</ResourceSection>)}</div></SettingsPageFrame>;
...
function ResourceCard({ id, title, description, status, statusLabel, category, action }: ResourceDefinition & { title: string; description: string; statusLabel: string; category: ResourceGroup["category"]; action?: React.ReactNode }) {
