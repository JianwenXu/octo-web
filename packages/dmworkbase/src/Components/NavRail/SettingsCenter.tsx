...
function SettingsPage({ item, onLanguageChange, onSecrets, onVoice }: { item?: SettingsItem; onLanguageChange: (locale: string) => void; onSecrets?: () => void; onVoice?: () => void }) {
  ...
  if (item?.id === "shortcuts") return <SettingsPageFrame title="键盘快捷键" description="查看当前客户端快捷键"><SettingsRow title="通用" description="常用操作"><div className="wk-settings-center__shortcut-list"><span>搜索</span><kbd>Ctrl / Cmd + K</kbd><span>设置</span><kbd>Ctrl / Cmd + ,</kbd><span>切换会话</span><kbd>Ctrl / Cmd + 1–9</kbd></div></SettingsRow><SettingsRow title="消息" description="会话内操作"><div className="wk-settings-center__shortcut-list"><span>发送消息</span><kbd>Enter</kbd><span>换行</span><kbd>Shift + Enter</kbd></div></SettingsRow></SettingsPageFrame>;
  if (item?.id === "devices") return <SettingsPageFrame title="在其他设备上使用 Octo" description="使用手机扫描二维码，快速获取已确认资源"><div className="wk-settings-center__qr-grid"><div className="wk-settings-center__qr-card"><QRCodeSVG value="https://github.com/Mininglamp-OSS/octo-android/releases/latest" size={176} /><strong>Octo Android</strong><span>Android 最新版本</span></div><div className="wk-settings-center__qr-card"><QRCodeSVG value="https://github.com/Mininglamp-AI/OctoASR" size={176} /><strong>OctoASR</strong><span>语音识别开源项目</span></div></div></SettingsPageFrame>;
