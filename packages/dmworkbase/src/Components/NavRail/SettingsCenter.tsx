...
export default function SettingsCenter({ visible, isDesktop = false, environment, accountCenterUrl, onClose, onLogout, onSecretsClosed, onAbout, onOpenOnboarding, openSecretsRequest }: SettingsCenterProps) {
