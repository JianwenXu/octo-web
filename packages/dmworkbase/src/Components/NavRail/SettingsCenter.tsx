...
export default function SettingsCenter({ visible, isDesktop = false, environment, hasAccountCenter = false, accountCenterUrl, onClose, onLogout, onSecretsClosed, onAbout, onOpenOnboarding, openSecretsRequest }: SettingsCenterProps) {
