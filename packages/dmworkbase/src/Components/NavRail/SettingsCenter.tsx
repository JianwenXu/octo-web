...
export default function SettingsCenter({ visible, isDesktop = false, environment, hasAccountCenter = false, accountCenterUrl, onClose, onSpaceManagement, onLogout, onSecrets, onVoice, onAbout }: SettingsCenterProps) {
