...
function SettingsPage({ item, onSecrets, onVoice, onAbout }: { item?: SettingsItem; onSecrets?: () => void; onVoice?: () => void; onAbout?: () => void }) {
  ...
  if (item?.id === "shortcuts") return <SettingsPageFrame title="键盘快捷键" description="只读查看当前客户端快捷键"><div className="wk-settings-center__shortcut-catalog"><section><h3>聊天</h3><SettingsRow title="新聊天" trailing={<kbd>Ctrl / Cmd + N</kbd>} /><SettingsRow title="快速聊天" trailing={<kbd>Ctrl / Cmd + Alt + N</kbd>} /><SettingsRow title="归档聊天" trailing={<kbd>Ctrl / Cmd + Shift + A</kbd>} /></section><section><h3>导航</h3><SettingsRow title="查找" trailing={<kbd>Ctrl / Cmd + F</kbd>} /><SettingsRow title="返回" trailing={<kbd>Alt / Option + ←</kbd>} /><SettingsRow title="前进" trailing={<kbd>Alt / Option + →</kbd>} /></section><section><h3>语音输入</h3><SettingsRow title="按住说话" trailing={<kbd>Ctrl / Cmd + Shift + Space</kbd>} /><SettingsRow title="取消语音输入" trailing={<kbd>Esc</kbd>} /></section></div></SettingsPageFrame>;
  if (item?.id === "devices") return <SettingsPageFrame title="在其他设备上使用 Octo" description="仅展示已确认地址或状态的资源"><div className="wk-settings-center__resource-list"><SettingsRow title="Octo Android" description="Android 最新版本" trailing={<a className="wk-settings-center__link" href="https://github.com/Mininglamp-OSS/octo-android/releases/latest" target="_blank" rel="noreferrer">从 GitHub 下载</a>} /><SettingsRow title="OctoASR" description="语音识别开源项目" trailing={<a className="wk-settings-center__link" href="https://github.com/Mininglamp-AI/OctoASR" target="_blank" rel="noreferrer">查看项目</a>} /><SettingsRow title="iPhone / Windows / macOS" description="下载地址或商店入口暂未确认" /></div></SettingsPageFrame>;
