...
export const settingsGroups: SettingsGroup[] = [
  { titleKey: "base.navRail.settingsCenter.group.settings", items: [{ id: "general", labelKey: "base.navRail.settingsCenter.item.general" }, { id: "account", labelKey: "base.navRail.settingsCenter.item.account" }, { id: "notifications", labelKey: "base.navRail.settingsCenter.item.notifications" }] },
