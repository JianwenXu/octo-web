    ...
    if (state === "error") {
      return (
        <div className="appbot-list-status">
          ...
          <button className="appbot-retry-btn" onClick={onRetry}>
            {retryLabel}
          </button>
        </div>
      );
  ...
  const renderItem = (bot: AppBotViewItem) => {
    ...
    return (
      <button
        key={bot.id}
        type="button"
        className={`appbot-list-item ${
          isActive ? "appbot-list-item-active" : ""
        }`}
      ...
      >
        ...
        <div className="appbot-list-info">
          ...
          <div className="appbot-list-desc">
            {bot.description || defaultDescription}
          </div>
        </div>
      </button>
    );
